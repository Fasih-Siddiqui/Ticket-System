...
export default function Sidebar({ onLogout, collapsed: collapsedProp, setCollapsed: setCollapsedProp }) {
  // If collapsed/setCollapsed are not provided, manage state internally
  const [internalCollapsed, internalSetCollapsed] = useState(false);
  const collapsed = typeof collapsedProp === 'boolean' ? collapsedProp : internalCollapsed;
  const setCollapsed = typeof setCollapsedProp === 'function' ? setCollapsedProp : internalSetCollapsed;
